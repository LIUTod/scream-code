...
STATIC_DIR = ROOT / "src" / "scream" / "web" / "static"

STRICT_VERSION = os.environ.get("SCREAM_WEB_STRICT_VERSION", "").lower() in {"1", "true", "yes"}
...
def main() -> int:
    ...
    explicit_expected = os.environ.get("SCREAM_WEB_EXPECT_VERSION")
