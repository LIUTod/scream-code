#!/usr/bin/env python3
"""Inject build SHA into src/scream/_build_info.py for telemetry provenance.
...
def _detect_sha() -> str:
    ...
    if sha := os.environ.get("SCREAM_BUILD_SHA", "").strip():
        return sha
...
def main() -> int:
    ...
    target = _resolve_project_root() / "src" / "scream" / "_build_info.py"
