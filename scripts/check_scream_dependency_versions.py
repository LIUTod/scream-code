...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate scream-cli dependency versions.")
    parser.add_argument("--root-pyproject", type=Path, required=True)
    parser.add_argument("--ltod-pyproject", type=Path, required=True)
    ...
    print("ok: scream-cli dependencies match workspace package versions")
    return 0
