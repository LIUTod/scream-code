...
<table>
  ...
  <tr>
    ...
    <td width="50%">
      <h3>📚 本地SAG图谱知识库</h3>
      <p><strong>基于论文：https://arxiv.org/abs/2606.15971 构建复现SAG知识库（大幅提高多跳推理能力），随时导入你的本地知识，让Agent更懂你</p>
    </td>
    <td width="50%">
      <h3>🛡️ 效率级轻量底层</h3>
  ...
  <tr>
    ...
    <td width="50%">
      <h3>⚡️ 多代理编排引擎</h3>
      <p><strong>支持为子Agent开启多代理编排模式，可自定义配置子Agent模型。让不同模型，去做自己最擅长的工作。</p>
    </td>
    <td width="50%">
      <h3>📱 多渠道互联</h3>
