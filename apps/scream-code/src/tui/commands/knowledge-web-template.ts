/**
 * /knowledge web — HTML shell for the knowledge-graph canvas page.
 * Pure string, no template interpolation: serveHTML injects the i18n dict
 * and locale via __DICT_INJECT__ / __LOCALE_INJECT__ replacements.
 * Split out of knowledge-web.ts so server code and page markup live apart.
 */
export const KNOWLEDGE_WEB_HTML = `<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
