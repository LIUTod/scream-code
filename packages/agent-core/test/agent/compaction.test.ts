...
describe('Agent compaction', () => {
  ...
  it('runs manual compaction and applies the compacted context', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated       { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 120, "maxContextTokens": 256000, "contextUsage": 0.00046875, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated       { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 5, "maxContextTokens": 256000, "contextUsage": 0.00001953125, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
    `);
  ...
  it('keeps messages appended while compacting an unchanged prefix', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated       { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 80, "maxContextTokens": 256000, "contextUsage": 0.0003125, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete   { "time": "<time>" }
      ...
      [emit] agent.status.updated       { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 5, "maxContextTokens": 256000, "contextUsage": 0.00001953125, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
    `);
    expect(ctx.lastLlmInput()).toMatchInlineSnapshot(`
      system: "You are a conversation context compaction assistant. Your job is to summarize the conversation above into a structured summary. Output text only. DO NOT CALL ANY TOOLS. Follow the compaction instruction in the last user message exactly. Pay special attention to the Memory Memo Extraction section — you MUST output memory-memo blocks for every completed task loop."
      tools: []
  ...
  it('cancels when the compacted prefix changes before completion', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated     { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 857, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 857, "output": 7, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 950000, "maxContextTokens": 256000, "contextUsage": 3.7109375, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
      ...
      [emit] agent.status.updated        { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 28, "maxContextTokens": 256000, "contextUsage": 0.000109375, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated        { "model": "scream-code", "thinkingLevel": "off", "contextTokens": 42, "maxContextTokens": 256000, "contextUsage": 0.0001640625, "planMode": false, "wolfpackMode": false, "permission": "manual", "usage": { "byModel": { "scream-code": { "inputOther": 887, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 887, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 31, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
