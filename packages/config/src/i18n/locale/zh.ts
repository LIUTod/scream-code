export const zh: Record<string, string> = {
  ...
  'goal.budget_turns': '轮次限制',
  'goal.budget_turns_desc': '达到指定轮次后停止',
  'goal.budget_tokens': 'Token 限制',
  'goal.budget_tokens_desc': '消耗指定 Token 数量后停止',
  'goal.budget_time': '时间限制',
  'goal.budget_time_desc': '达到指定时长后停止',
  'goal.budget_none': '不限制',
  'goal.budget_none_desc': '持续运行直到目标达成或手动停止',
  'goal.judge_ai': 'AI 裁判',
  'goal.judge_ai_desc': '由 AI 自动评估目标是否达成',
  'goal.judge_shell': 'Shell 命令',
  'goal.judge_shell_desc': '通过运行 Shell 命令验证目标是否完成',
  'goal.judge_manual': '手动判断',
  'goal.judge_manual_desc': '由你自行判断目标是否完成',
  'goal.shell_command_prompt': '输入验证命令',
