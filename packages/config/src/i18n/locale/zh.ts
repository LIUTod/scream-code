export const zh: Record<string, string> = {
  ...
  'status.reconnecting_short': '重连中 {attempt}/{max}',
  ...
  'knowledge.search_deep': '深度搜索',
  'knowledge.search_deep_desc': '走 LLM 实体抽取+重排：更准但更慢（默认搜索为纯本地快速模式）',
  'knowledge.vector_degraded': '向量模型未就绪，当前为关键词检索模式。可在 /knowledge 菜单重新下载模型。',
  ...
  'knowledge.embedding_platform_hint': '当前平台缺少本地向量模型二进制；知识库仍可用关键词检索',
  'knowledge.embedding_cache_corrupt_hint': '本地模型缓存已损坏；清理并重试仍未成功，请稍后再试',
  'knowledge.embedding_network_hint': '可返回菜单重选「下载向量模型」重试；网络受限时可用代理',
  'knowledge.embedding_unknown_hint': '请再试一次；若持续失败，请把下面这行错误信息反馈给我们',
  ...
  'auth.api_url_hint': '例如 https://api.example.com（可粘贴）',
  'auth.api_url_hint_google': '例如 https://generativelanguage.googleapis.com（官方）或代理/网关地址（可粘贴）',
  'auth.input_api_key': '输入 API Key',
  'auth.api_key_hint': '密钥保存到 ~/.scream/config.toml（可粘贴，Esc 取消）',
  'auth.input_model': '输入模型型号',
  'auth.model_hint': '例如 my-model-v2',
  'auth.model_hint_google': '例如 gemini-2.5-pro',
  'auth.input_context': '输入模型最大上下文长度 (tokens)',
  'auth.context_hint': '默认 131072，请查阅你的服务商获取准确限制',
  'auth.context_hint_google': '默认 1048576（Gemini 2.5 百万窗口），请查阅你的服务商获取准确限制',
  'auth.connected': '已连接: {name}',
  'auth.error_empty_base_url': 'API 地址不能为空。',
  'auth.error_empty_model_id': '模型名称不能为空。',
  'auth.error_invalid_context_size': '上下文长度必须是 >= 4096 的数字。',
  ...
  'editor.tip_4': '💡 Tips：输入 /model diy 可为子代理配置不同模型  【Ctrl+B 关闭 Tips】',
  'editor.tip_5': '💡 Tips：输入 /config diy 可添加自定义模型  【Ctrl+B 关闭 Tips】',
  'editor.tip_6': '💡 Tips：使用中不建议切换模型，丢失缓存会导致命中率下降  【Ctrl+B 关闭 Tips】',
  ...
  'prompts.wire_openai_desc': 'Chat Completions API 兼容的服务商',
  'prompts.wire_openai_responses': 'Responses API 协议',
  ...
  'prompts.wire_google_genai': 'Google GenAI 协议',
  'prompts.wire_google_genai_desc': 'Gemini generateContent API 兼容的服务商',
  ...
  'registry.mermaid_desc': '选择 Mermaid 图的渲染方式',
  'mermaid.picker_title': 'Mermaid 图渲染',
  'mermaid.picker_hint': '↑↓ 选择 · Enter 确认 · Esc 取消',
  'mermaid.picker_cancelled': '未改动，当前仍为「{mode}」',
  'mermaid.usage': '用法：/mermaid [on|ascii|off]',
  'mermaid.option.on': '开',
  'mermaid.option.ascii': '双宽模式',
  'mermaid.option.off': '关',
  'mermaid.desc.on': '把 ```mermaid 画成图（制表符边框）',
  'mermaid.desc.ascii': '照样画，但边框改用 ASCII 字符 —— 终端把制表符画成两格宽时用这个',
  'mermaid.desc.off': '不画，mermaid 块保持原样代码',
  'mermaid.applied': 'Mermaid 图渲染已设为「{mode}」',
  'mermaid.note.not_rendered': 'Mermaid 图未渲染：{reason}',
  'mermaid.note.incomplete': 'Mermaid 图未完整渲染：{reason}',
  'mermaid.note.wider': '比当前终端还宽（{width} > {available} 列）—— 把窗口拉宽一些，或让它拆成两张更小的图',
  'mermaid.note.flipped': '已自动改用更省纵向空间的排布方向',
  'mermaid.note.unsupported': '终端不画这类图',
  'mermaid.note.unparsed': '源码没能解析',
  'registry.cron_desc': '查看与管理定时任务',
  'cron.panel_title': '定时任务',
  'cron.panel_hint': '↑↓ 选择 · d 删除 · /cron add 新建 · Esc 关闭',
  'cron.empty': '还没有定时任务',
  'cron.empty_hint': '回车新建一个',
  'cron.no_next_fire': '无下次触发',
  'cron.firing': '即将触发',
  'cron.in_seconds': '{n} 秒后',
  'cron.in_minutes': '{n} 分钟后',
  'cron.in_hours': '{n} 小时后',
  'cron.in_days': '{n} 天后',
  'cron.kind_recurring': '重复',
  'cron.kind_once': '一次性',
  'cron.stale': '已过期',
  'cron.sched_5m': '每 5 分钟',
  'cron.sched_hourly': '每小时',
  'cron.sched_daily9': '每天 09:00',
  'cron.sched_daily18': '每天 18:00',
  'cron.sched_weekdays9': '工作日 09:00',
  'cron.sched_custom': '自定义表达式…',
  'cron.sched_custom_hint': '5 段 cron：分 时 日 月 周',
  'cron.sched_every_minutes': '每 {n} 分钟',
  'cron.sched_daily': '每天 {time}',
  'cron.sched_weekdays': '工作日 {time}',
  'cron.wizard_schedule_title': '什么时候触发？',
  'cron.wizard_schedule_hint': '↑↓ 选择 · Enter 下一步 · Esc 取消',
  'cron.wizard_custom_title': '自定义 cron 表达式',
  'cron.wizard_custom_hint': '分 时 日 月 周，例如 */5 * * * *',
  'cron.wizard_task_title': '要它做什么？',
  'cron.wizard_task_placeholder': '例如：检查 CI 状态并汇报失败原因',
  'cron.wizard_kind_title': '只做一次，还是每次都做？',
  'cron.wizard_kind_hint': '↑↓ 选择 · Enter 确认 · Esc 取消',
  'cron.kind_recurring_hint': '按表达式反复触发，直到被删除',
  'cron.kind_once_hint': '只在下一次触发，随后自动删除',
  'cron.cancelled': '已取消',
  'cron.creating': '正在创建定时任务…',
  'cron.created': '定时任务已创建',
  'cron.create_failed': '创建失败',
  'cron.deleting': '正在删除定时任务…',
  'cron.deleted': '定时任务已删除',
  'cron.not_found': '该任务不存在（可能已被删除）',
  'cron.delete_failed': '删除失败',
  'cron.confirm_title': '删除这个定时任务？',
  'cron.confirm_hint': '删除后不可恢复',
  'cron.confirm_delete': '确认删除',
  'cron.usage': '用法：/cron [list|add|rm <id>]',
  'cron.no_session': '当前没有会话',
