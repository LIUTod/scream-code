export const en: Record<string, string> = {
  ...
  'goal.budget_turns': 'Turn Limit',
  'goal.budget_turns_desc': 'Stop after a fixed number of turns',
  'goal.budget_tokens': 'Token Limit',
  'goal.budget_tokens_desc': 'Stop after consuming a token budget',
  'goal.budget_time': 'Time Limit',
  'goal.budget_time_desc': 'Stop after a wall-clock duration',
  'goal.budget_none': 'No Limit',
  'goal.budget_none_desc': 'Run until the goal is achieved or manually stopped',
  'goal.judge_ai': 'AI Judge',
  'goal.judge_ai_desc': 'Let the AI evaluate whether the goal is achieved',
  'goal.judge_shell': 'Shell Command',
  'goal.judge_shell_desc': 'Verify completion by running a shell command',
  'goal.judge_manual': 'Manual',
  'goal.judge_manual_desc': 'You decide when the goal is done',
  'goal.shell_command_prompt': 'Enter verification command',
