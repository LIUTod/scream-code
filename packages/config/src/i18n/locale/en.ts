export const en: Record<string, string> = {
  ...
  'status.awaiting_answer': 'Awaiting answer',
  'status.reconnecting_short': 'Retrying {attempt}/{max}',
  ...
  'knowledge.search_deep': 'Deep search',
  'knowledge.search_deep_desc': 'LLM entity recall + rerank: slower but more precise (default search is local-only fast mode)',
  ...
  'auth.api_url_hint': 'e.g. https://api.example.com (paste supported)',
  'auth.api_url_hint_google': 'e.g. https://generativelanguage.googleapis.com (official) or a proxy/gateway URL (paste supported)',
  ...
  'auth.model_hint': 'e.g. my-model-v2',
  'auth.model_hint_google': 'e.g. gemini-2.5-pro',
  'auth.input_context': 'Enter max context length (tokens)',
  'auth.context_hint': 'Default 131072; check your provider for the exact limit',
  'auth.context_hint_google': 'Default 1048576 (Gemini 2.5 1M window); check your provider for the exact limit',
  'auth.connected': 'Connected: {name}',
  'auth.error_empty_base_url': 'Base URL cannot be empty.',
  'auth.error_empty_model_id': 'Model name cannot be empty.',
  'auth.error_invalid_context_size': 'Context size must be a number >= 4096.',
  ...
  'editor.tip_4': '💡 Tips: Type /model diy to configure a different model for sub-agents  [Ctrl+B to hide Tips]',
  'editor.tip_5': '💡 Tips: Type /config diy to add a custom model  [Ctrl+B to hide Tips]',
  'editor.tip_6': '💡 Tips: Avoid switching models mid-session - cache loss reduces hit rate  [Ctrl+B to hide Tips]',
  ...
  'prompts.wire_openai_desc': 'Chat Completions API compatible providers',
  'prompts.wire_openai_responses': 'Responses API protocol',
  ...
  'prompts.wire_google_genai': 'Google GenAI protocol',
  'prompts.wire_google_genai_desc': 'Gemini generateContent API compatible providers',
  ...
  'registry.mermaid_desc': 'Choose how Mermaid diagrams are rendered',
  'mermaid.picker_title': 'Mermaid diagram rendering',
  'mermaid.picker_hint': '↑↓ select · Enter confirm · Esc cancel',
  'mermaid.picker_cancelled': 'Unchanged — still “{mode}”',
  'mermaid.usage': 'Usage: /mermaid [on|ascii|off]',
  'mermaid.option.on': 'On',
  'mermaid.option.ascii': 'Double-width safe',
  'mermaid.option.off': 'Off',
  'mermaid.desc.on': 'Draw ```mermaid blocks as pictures (box-drawing frames)',
  'mermaid.desc.ascii': 'Still draw, but frame with ASCII characters — for terminals that render box glyphs two cells wide',
  'mermaid.desc.off': 'Don\'t draw; mermaid blocks stay source',
  'mermaid.applied': 'Mermaid rendering set to “{mode}”',
  'mermaid.note.not_rendered': 'Mermaid diagram not rendered: {reason}',
  'mermaid.note.incomplete': 'Mermaid diagram incomplete: {reason}',
  'mermaid.note.wider': 'wider than this terminal ({width} > {available} columns) — widen the window, or ask for two smaller diagrams',
  'mermaid.note.flipped': 'laid out in the more compact direction automatically',
  'mermaid.note.unsupported': 'this diagram type is not drawn in the terminal',
  'mermaid.note.unparsed': 'the source did not parse',
  'registry.cron_desc': 'View and manage scheduled tasks',
  'cron.panel_title': 'Scheduled tasks',
  'cron.panel_hint': '↑↓ select · d delete · /cron add to create · Esc close',
  'cron.empty': 'No scheduled tasks yet',
  'cron.empty_hint': 'Press Enter to create one',
  'cron.no_next_fire': 'no next fire',
  'cron.firing': 'firing now',
  'cron.in_seconds': 'in {n}s',
  'cron.in_minutes': 'in {n}m',
  'cron.in_hours': 'in {n}h',
  'cron.in_days': 'in {n}d',
  'cron.kind_recurring': 'repeats',
  'cron.kind_once': 'one-shot',
  'cron.stale': 'expired',
  'cron.sched_5m': 'Every 5 minutes',
  'cron.sched_hourly': 'Hourly',
  'cron.sched_daily9': 'Daily at 09:00',
  'cron.sched_daily18': 'Daily at 18:00',
  'cron.sched_weekdays9': 'Weekdays at 09:00',
  'cron.sched_custom': 'Custom expression…',
  'cron.sched_custom_hint': '5-field cron: minute hour day month weekday',
  'cron.sched_every_minutes': 'every {n} min',
  'cron.sched_daily': 'daily at {time}',
  'cron.sched_weekdays': 'weekdays at {time}',
  'cron.wizard_schedule_title': 'When should it run?',
  'cron.wizard_schedule_hint': '↑↓ select · Enter next · Esc cancel',
  'cron.wizard_custom_title': 'Custom cron expression',
  'cron.wizard_custom_hint': 'minute hour day month weekday, e.g. */5 * * * *',
  'cron.wizard_task_title': 'What should it do?',
  'cron.wizard_task_placeholder': 'e.g. check CI status and report failures',
  'cron.wizard_kind_title': 'Once, or every time?',
  'cron.wizard_kind_hint': '↑↓ select · Enter confirm · Esc cancel',
  'cron.kind_recurring_hint': 'Fire on every cron match until deleted',
  'cron.kind_once_hint': 'Fire at the next match, then delete itself',
  'cron.cancelled': 'Cancelled',
  'cron.creating': 'Creating scheduled task…',
  'cron.created': 'Scheduled task created',
  'cron.create_failed': 'Could not create it',
  'cron.deleting': 'Deleting scheduled task…',
  'cron.deleted': 'Scheduled task deleted',
  'cron.not_found': 'No such task (it may be gone already)',
  'cron.delete_failed': 'Could not delete it',
  'cron.confirm_title': 'Delete this scheduled task?',
  'cron.confirm_hint': 'This cannot be undone',
  'cron.confirm_delete': 'Delete',
  'cron.usage': 'Usage: /cron [list|add|rm <id>]',
  'cron.no_session': 'No active session',
