...
class ContentPart(BaseModel, ABC, MergeableMixin):
    ...
    For ltod users, you typically do not need to subclass this directly. Instead, use the provided
...
type Role = Literal[
    ...
    # OpenAI & Scream support system messages in the middle of the conversation.
