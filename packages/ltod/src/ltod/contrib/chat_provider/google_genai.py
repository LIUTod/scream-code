try:
    ...
    raise ModuleNotFoundError(
        ...
        'Install with `pip install "ltod[contrib]"`.'
    ) from exc
...
from ltod.tooling import Tool as LtodTool
...
def tool_to_google_genai(tool: LtodTool) -> Tool:
    """Convert a ltod tool to GoogleGenAI tool format."""
...
def _convert_error(error: Exception) -> ChatProviderError:
    """Convert a GoogleGenAI error to a ltod chat provider error."""
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        import ltod
        from ltod.tooling import CallableTool2, ToolOk
        ...
        result = await ltod.step(chat, system_prompt, toolset, history)
