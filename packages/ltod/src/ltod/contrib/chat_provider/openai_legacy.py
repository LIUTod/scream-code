...
from ltod.contrib.chat_provider.common import ToolMessageConversion
from ltod.message import ContentPart, Message, TextPart, ThinkPart, ToolCall, ToolCallPart
...
class OpenAILegacy:
    ...
    async def generate(
        ...
        # See: https://github.com/MoonshotAI/scream-cli/issues/1616
    ...
    def _convert_message(self, message: Message) -> ChatCompletionMessageParam:
        """Convert a ltod message to OpenAI message."""
