...
from ltod.message import Message, ToolCall, ToolCallPart
...
class ChaosChatProvider:
    ...
    def for_scream(
        ...
        """Helper to wrap a Scream provider without changing caller sites."""
        from ltod.chat_provider.scream import Scream

        return cls(Scream(**kwargs), chaos_config=chaos_config)
