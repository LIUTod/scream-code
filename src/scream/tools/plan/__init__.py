...
from ltod.tooling import BriefDisplayBlock, CallableTool2, ToolError, ToolReturnValue
from pydantic import BaseModel, Field, field_validator

from scream.soul import get_wire_or_none, wire_send
from scream.soul.toolset import get_current_tool_call_or_none
from scream.tools.utils import ToolRejectedError, load_desc
...
class ExitPlanMode(CallableTool2[Params]):
    ...
    def bind(
        ...
        """Late-bind soul callbacks after ScreamSoul is constructed."""
