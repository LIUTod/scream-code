...
from scream.session_state import TodoItemState
from scream.soul.agent import Runtime
from scream.tools.display import TodoDisplayBlock, TodoDisplayItem
...
class SetTodoList(CallableTool2[Params]):
    ...
    def _write_subagent_state(path: Path, data: dict[str, Any]) -> None:
        from scream.utils.io import atomic_json_write
