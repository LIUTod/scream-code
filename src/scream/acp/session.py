...
from scream.acp.convert import (
    acp_blocks_to_content_parts,
    display_block_to_acp_content,
    tool_result_to_acp_content,
)
from scream.acp.types import ACPContentBlock
from scream.app import ScreamCLI
from scream.soul import LLMNotSet, LLMNotSupported, MaxStepsReached, RunCancelled
from scream.tools import extract_key_argument
...
class ACPSession:
    ...
    @property
    def cli(self) -> ScreamCLI:
        """The Scream Code CLI instance bound to this ACP session."""
        return self._cli
