...
from scream.tools.shell import Params as ShellParams
from scream.tools.shell import Shell
from scream.tools.utils import ToolResultBuilder
...
class Terminal(CallableTool2[ShellParams]):
    ...
    async def __call__(self, params: ShellParams) -> ToolReturnValue:
        from scream.acp.session import get_current_acp_tool_call_id_or_none
