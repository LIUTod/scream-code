...
from scream.hooks.config import HookDef
from scream.llm import ModelCapability, ProviderType
...
class Config(BaseModel):
    ...
    merge_all_available_skills: bool = Field(
        default=True,
        description=(
            "Merge skills from all existing brand directories (scream/claude/codex) "
