...
from scream.utils.rich.syntax import SCREAM_ANSI_THEME_NAME, resolve_code_theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = SCREAM_ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "scream-ansi".
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = SCREAM_ANSI_THEME_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--code-theme",
        dest="code_theme",
        default=SCREAM_ANSI_THEME_NAME,
        help='code theme (pygments name or "scream-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
