...
from scream.ui.shell.visualize._btw_panel import _BtwModalDelegate
from scream.ui.shell.visualize._input_router import InputAction, classify_input
from scream.ui.shell.visualize._live_view import _LiveView
    ...
    def handle_local_input(self, user_input: UserInput) -> None:
        ...
        match action.kind:
            ...
            case InputAction.QUEUE:
                ...
                from scream.utils.slashcmd import parse_slash_command_call

                if cmd := parse_slash_command_call(user_input.resolved_command.strip()):
                    from scream.ui.shell.slash import registry as shell_registry
