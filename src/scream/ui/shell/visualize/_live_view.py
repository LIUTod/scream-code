...
from scream.ui.shell.keyboard import KeyboardListener, KeyEvent
...
from scream.utils.datetime import format_elapsed
...
class _LiveView:
    def __init__(
        ...
        *,
        ...
        self._mooning_spinner = Spinner("scream-moon", "")
