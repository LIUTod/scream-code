...
class _ScreamConsole(Console):
    """Console subclass that defaults to :class:`_ScreamPager`."""
...
console = _ScreamConsole(highlight=False, theme=NEUTRAL_MARKDOWN_THEME)
