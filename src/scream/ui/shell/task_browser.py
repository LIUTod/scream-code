...
from scream.background import TaskView, is_terminal_status
from scream.soul.screamsoul import ScreamSoul
from scream.ui.shell.console import console
from scream.utils.datetime import format_duration, format_relative_time
...
def _task_browser_style() -> Style:
    from scream.ui.theme import get_task_browser_style
