...
from scream.utils.envvar import get_env_int
from scream.utils.logging import logger
from scream.utils.media_tags import wrap_media_part
from scream.utils.string import random_string
from scream.wire.types import ContentPart, ImageURLPart, TextPart

_DEFAULT_PROMPT_CACHE_ROOT = get_share_dir() / "prompt-cache"
_LEGACY_PROMPT_CACHE_ROOT = Path("/tmp/scream")
...
_TEXT_PASTE_CHAR_THRESHOLD = get_env_int("SCREAM_CLI_PASTE_CHAR_THRESHOLD", 1000)
_TEXT_PASTE_LINE_THRESHOLD = get_env_int("SCREAM_CLI_PASTE_LINE_THRESHOLD", 15)
