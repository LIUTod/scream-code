...
from scream.cli import ExitCode, InputFormat, OutputFormat
...
from scream.ui.print.visualize import visualize
from scream.utils.logging import logger, open_original_stderr
                ...
                if command:
                    ...
                    if (
                        ...
                        if timed_out:
                            ...
                            # silently land in ``scream.log``.  Use the
