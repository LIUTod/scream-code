...
class LazySubcommandGroup(typer.core.TyperGroup):
    ...
    lazy_subcommands: dict[str, tuple[str, str, str]] = {
        "info": ("scream.cli.info", "cli", "Show version and protocol information."),
        "export": ("scream.cli.export", "cli", "Export session data."),
        "mcp": ("scream.cli.mcp", "cli", "Manage MCP server configurations."),
        "plugin": ("scream.cli.plugin", "cli", "Manage plugins."),
    }
