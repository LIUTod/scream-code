...
def get_plugins_dir() -> Path:
    """Return the plugins installation directory (~/.scream/plugins/)."""
...
def collect_host_values(config: Config) -> dict[str, str]:
    ...
    Resolves credentials from the default provider.
    Callers that run outside the normal startup flow
