...
from scream.wire.types import ToolReturnValue
...
class PluginTool(CallableTool):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._inject = inject  # e.g. {"screamCodeAPIKey": "api_key"}
        self._config = config
        ...
        if self._inject:
            ...
            for target_key, source_key in self._inject.items():
                if source_key in host_values:
                    ...
                    # e.g. screamCodeAPIKey=<fresh api_key>
...
def load_plugin_tools(
    ...
    from scream.plugin import PLUGIN_JSON, PluginError, parse_plugin_json
