...
from scream.tools.display import (
...
from scream.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `scream.soul.approval.Request`, but
