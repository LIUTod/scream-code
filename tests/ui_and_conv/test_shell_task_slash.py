...
from scream.subagents import AgentLaunchSpec
from scream.tools.display import ShellDisplayBlock
from scream.ui.shell import Shell
from scream.ui.shell import slash as shell_slash
from scream.wire.types import ApprovalRequest
...
async def test_task_command_launches_browser(runtime: Runtime, tmp_path: Path, monkeypatch) -> None:
    ...
    class _FakeTaskBrowserApp:
        def __init__(self, soul: ScreamSoul):
