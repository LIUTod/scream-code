...
from scream.wire.types import ApprovalRequest, ApprovalResponse, QuestionRequest, StatusUpdate
...
async def test_render_agent_status_excludes_panels_in_interactive() -> None:
    ...
    from scream.ui.shell.visualize import _PromptLiveView
...
async def test_shell_external_approval_response_syncs_modal(
    ...
    from scream.approval_runtime import ApprovalSource
    ...
    soul = ScreamSoul(agent, context=Context(file_backend=tmp_path / "h.jsonl"))
    shell = Shell(soul)
