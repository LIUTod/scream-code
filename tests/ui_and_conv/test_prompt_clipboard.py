...
from scream.ui.shell.prompt import PromptMode
from scream.utils.clipboard import ClipboardResult
...
async def test_question_delegate_expands_placeholders_on_submit() -> None:
    ...
    from scream.ui.shell.visualize import QuestionPromptDelegate, QuestionRequestPanel
    from scream.wire.types import QuestionItem, QuestionRequest
