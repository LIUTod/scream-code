...
from ltod.tooling import ToolResult, ToolReturnValue
...
def test_empty_think_then_real_think_no_artifact(monkeypatch):
    ...
    from scream.ui.shell.console import console as shell_console
...
def test_step_retry_clears_partial_content_and_updates_live_status(monkeypatch):
    ...
    live_view_mod = importlib.import_module("scream.ui.shell.visualize._live_view")
    view = _LiveView(StatusUpdate())
    printed = []
    monkeypatch.setattr(
