...
from scream.cli import Reload, SwitchToVis, SwitchToWeb
from scream.ui.shell.slash import ShellSlashCmdFunc, shell_mode_registry
...
class TestWebCommandBehavior:
    ...
    async def test_session_id_none_without_scream_soul(self) -> None:
        """When soul is not a ScreamSoul, session_id should be None."""
        shell = Mock()
