...
from scream.config import Config, get_default_config
...
def test_theme_command_registered_in_both_registries():
    from scream.ui.shell.slash import registry, shell_mode_registry
...
async def test_shell_startup_initializes_theme_from_config(
    ...
    from scream.ui import theme as theme_mod
    from scream.ui.shell import Shell as RealShell
