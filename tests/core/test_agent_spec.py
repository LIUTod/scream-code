...
from scream.agentspec import DEFAULT_AGENT_FILE, load_agent_spec
from scream.exception import AgentSpecError
...
def test_load_default_agent_spec():
    ...
    assert spec.tools == snapshot(
        [
            "scream.tools.agent:Agent",
            "scream.tools.ask_user:AskUserQuestion",
            "scream.tools.todo:SetTodoList",
            "scream.tools.shell:Shell",
            "scream.tools.background:TaskList",
            "scream.tools.background:TaskOutput",
            "scream.tools.background:TaskStop",
            "scream.tools.file:ReadFile",
            "scream.tools.file:ReadMediaFile",
            "scream.tools.file:Glob",
            "scream.tools.file:Grep",
            "scream.tools.file:WriteFile",
            "scream.tools.file:StrReplaceFile",
            "scream.tools.web:SearchWeb",
            "scream.tools.web:FetchURL",
            "scream.tools.plan:ExitPlanMode",
            "scream.tools.plan.enter:EnterPlanMode",
        ]
    )
    subagents = {
...
def test_load_agent_spec_basic(agent_file: Path):
    ...
    assert spec.tools == snapshot(["scream.tools.think:Think"])
...
def test_load_agent_spec_with_exclude_tools(agent_file_with_tools: Path):
    ...
    assert spec.tools == snapshot(["scream.tools.think:Think", "scream.tools.shell:Shell"])
    assert spec.exclude_tools == snapshot(["scream.tools.shell:Shell"])
...
""")
        ...
        assert spec.exclude_tools == snapshot(
            ["scream.tools.web:SearchWeb", "scream.tools.web:FetchURL"]
        )
...
agent:
  name: "Test Agent"
  system_prompt_path: ./system.md
  tools: ["scream.tools.think:Think", "scream.tools.shell:Shell"]
  exclude_tools: ["scream.tools.shell:Shell"]
""")
