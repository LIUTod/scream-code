...
from ltod.message import TextPart as MessageTextPart
...
from scream.wire.jsonrpc import (
    ErrorCodes,
...
def _make_soul(runtime: Runtime, provider, tmp_path: Path, *, oauth: bool = False) -> ScreamSoul:
