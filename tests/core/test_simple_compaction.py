...
from ltod.chat_provider import TokenUsage
from ltod.message import AudioURLPart, ImageURLPart, Message, VideoURLPart

import scream.prompts as prompts
from scream.soul.compaction import CompactionResult, SimpleCompaction, should_auto_compact
from scream.wire.types import TextPart, ThinkPart
...
def test_prepare_only_keeps_text_parts_in_compaction():
    ...
    Fixes: https://github.com/LIUTod/scream-code/issues/1395
    Fixes: https://github.com/LIUTod/scream-code/issues/1390
    """
    messages = [
        Message(
            role="user",
