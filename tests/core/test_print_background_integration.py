...
Unlike the unit tests in test_screamsoul_background_wait.py (which mock
...
from scream.background.models import TaskRuntime, TaskSpec
from scream.cli import ExitCode
from scream.config import BackgroundConfig, NotificationConfig
from scream.notifications.manager import NotificationManager
