...
from scream.wire.types import ApprovalRequest, ApprovalResponse
...
@pytest.mark.asyncio
async def test_screamsoul_run_preserves_existing_approval_source(
...
@pytest.mark.asyncio
async def test_screamsoul_run_cancels_own_foreground_approvals_on_cancel(
    runtime, tmp_path, monkeypatch
) -> None:
