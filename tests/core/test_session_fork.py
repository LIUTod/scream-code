"""Tests for scream.session_fork module."""
...
from scream.session_fork import (
    TurnInfo,
    _extract_user_text,
...
from scream.wire.file import WireFileMetadata, WireMessageRecord  # noqa: I001
from scream.wire.protocol import WIRE_PROTOCOL_VERSION
from scream.wire.types import TextPart, TurnBegin, TurnEnd
...
class TestForkSession:
    ...
    async def test_fork_sets_title(self, isolated_share_dir: Path, work_dir: KaosPath):
        from scream.session import Session
        from scream.session_state import load_session_state
