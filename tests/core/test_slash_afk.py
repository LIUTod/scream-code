...
from scream.soul.slash import afk as afk_slash
from scream.soul.slash import yolo as yolo_slash
...
async def _run(fn, soul: ScreamSoul, args: str = "") -> None:
    result = fn(soul, args)
...
async def test_afk_slash_toggles_afk_flag(
    ...
    sent: list[TextPart] = []
    monkeypatch.setattr("scream.soul.slash.wire_send", lambda msg: sent.append(msg))
...
async def test_afk_slash_notifies_injection_providers(
    ...
    monkeypatch.setattr("scream.soul.slash.wire_send", lambda _msg: None)
