...
from ltod.message import ContentPart, ImageURLPart, Message, TextPart, ToolCall
from ltod.tooling import CallableTool2, Tool, ToolResult, ToolReturnValue, Toolset
from ltod.tooling.simple import SimpleToolset
from pydantic import BaseModel

from scream.llm import LLM, ModelCapability
...
from scream.wire.types import TurnBegin
...
async def _run_and_collect_turns(
    soul: ScreamSoul, user_input: str | list[ContentPart]
