...
import pytest
from ltod.message import ContentPart
...
from scream.telemetry import set_context
...
from scream.wire.types import ApprovalRequest, ApprovalResponse, TextPart
...
async def test_handle_prompt_cleanup_keeps_background_approval_pending(
    ...
    monkeypatch.setattr("scream.wire.server.run_soul", fake_run_soul)
