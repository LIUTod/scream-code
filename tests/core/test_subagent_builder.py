...
from scream.soul.agent import load_agent
from scream.subagents.builder import SubagentBuilder
from scream.subagents.models import AgentLaunchSpec, AgentTypeDefinition, ToolPolicy
...
async def test_builder_model_priority_prefers_override_then_type_default_then_inherit(
    ...
    monkeypatch.setattr(
        "scream.subagents.builder.clone_llm_with_model_alias",
