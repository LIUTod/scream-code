...
from scream.ui.shell.console import _ScreamPager, console
...
class TestConsolePagerIgnoresManpager:
    ...
    def test_pager_context_uses_scream_pager_by_default(self):
    ...
    def test_manpager_stripped_during_pydoc_pager(self):
        """When MANPAGER is set, _ScreamPager must strip it before calling pydoc.pager()."""
        pager = _ScreamPager()
