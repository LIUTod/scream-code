"""Tests for scream.utils.rich.diff_render — unified diff rendering."""
...
from scream.utils.diff import _build_diff_blocks_sync as build_diff_blocks
...
class TestHighlightHunk:
    ...
    def test_inline_diff_with_tabs(self) -> None:
        ...
        from scream.utils.rich.diff_render import get_diff_colors
