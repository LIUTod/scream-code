...
from scream.config import Config, SearchConfig, get_default_config
from scream.llm import ALL_MODEL_CAPABILITIES, LLM
from scream.metadata import WorkDirMeta
from scream.notifications import NotificationManager
from scream.session import Session
from scream.session_state import SessionState
from scream.soul.agent import BuiltinSystemPromptArgs, LaborMarket, Runtime
...
from scream.subagents import AgentTypeDefinition, ToolPolicy
from scream.tools.agent import Agent as AgentTool
from scream.tools.background import (
    TaskList,
    TaskOutput,
    TaskStop,
)
from scream.tools.dmail import SendDMail
from scream.tools.file.glob import Glob
from scream.tools.file.grep_local import Grep
from scream.tools.file.read import ReadFile
from scream.tools.file.read_media import ReadMediaFile
from scream.tools.file.replace import StrReplaceFile
from scream.tools.file.write import WriteFile
from scream.tools.shell import Shell
from scream.tools.think import Think
from scream.tools.todo import SetTodoList
from scream.tools.web.fetch import FetchURL
from scream.tools.web.search import SearchWeb
...
def config() -> Config:
    ...
    conf.services.search = SearchConfig(
        base_url="https://api.example.com/coding/v1/search",
...
@pytest.fixture
def toolset() -> ScreamToolset:
    return ScreamToolset()


@contextmanager
def tool_call_context(tool_name: str) -> Generator[None]:
    """Create a tool call context."""
    from scream.soul.toolset import current_tool_call
