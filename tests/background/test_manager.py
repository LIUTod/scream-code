...
from scream.approval_runtime import ApprovalRequestRecord, ApprovalRuntimeEvent, ApprovalSource
from scream.background import TaskRuntime, TaskSpec
from scream.background.agent_runner import BackgroundAgentRunner
from scream.notifications import NotificationDelivery, NotificationEvent, NotificationView
...
from scream.wire.types import TextPart
...
async def test_create_agent_task_persists_timeout_s_on_spec(runtime, monkeypatch):
    ...
    monkeypatch.setattr("scream.background.agent_runner.BackgroundAgentRunner.run", _noop)
