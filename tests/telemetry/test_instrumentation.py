...
import scream.telemetry as telemetry_mod
from scream.telemetry import attach_sink, disable, set_context, track
from scream.telemetry.sink import EventSink
from scream.telemetry.transport import AsyncTransport
...
class TestAPIErrorClassification:
    ...
    def test_429_maps_to_rate_limit(self):
        from scream.soul.screamsoul import classify_api_error
    ...
    def test_connection_error_maps_to_network(self):
        from ltod.chat_provider import APIConnectionError
    ...
    def test_api_timeout_maps_to_timeout(self):
        from ltod.chat_provider import APITimeoutError
    ...
    def test_empty_response_maps_to_empty_response(self):
        from ltod.chat_provider import APIEmptyResponseError
...
class TestInfrastructureEdgeCases:
    ...
    async def test_transport_send_falls_back_to_disk_on_transient_error(self):
        ...
        from scream.telemetry.transport import _TransientError
    ...
    async def test_disk_file_expiry(self, tmp_path: Path):
        ...
        with (
            patch("scream.telemetry.transport._telemetry_dir", return_value=tmp_path),
...
class TestEventPropertyCorrectness:
    ...
    def test_model_switch_has_model_string(self):
        ...
        track("model_switch", model="scream-k2.5")
        event = _collect_events()[-1]
        assert event["properties"]["model"] == "scream-k2.5"
    ...
    def test_background_task_no_event_without_start_time(self):
        ...
        from scream.background.manager import BackgroundTaskManager
        from scream.background.models import TaskRuntime
        ...
        with patch("scream.telemetry.track") as mock_track:
...
class TestSessionStarted:
    ...
    def test_client_info_stored_as_tuple(self):
        ...
        set_client_info(name="scream-web", version="2.0.0")
        assert telemetry_mod._client_info == ("scream-web", "2.0.0")
    ...
    def test_track_session_started_wire_uses_current_client_info(self):
        from scream.telemetry import set_client_info, track_session_started_once
    ...
    def test_track_session_started_explicit_client_info_wins(self):
        ...
        track_session_started_once(
            ui_mode="wire",
            resumed=False,
            client_name="scream-code-for-vs-code",
            client_version="1.90.0",
        )

        event = _collect_events()[-1]
        assert event["properties"]["client_name"] == "scream-code-for-vs-code"
...
class TestCompactionTracking:
    ...
    def _make_soul(self, *, before_tokens: int, estimated_after: int) -> Any:
        """Construct a minimal ScreamSoul stub bypassing __init__."""
        from scream.soul.screamsoul import ScreamSoul

        soul = object.__new__(ScreamSoul)
    ...
    async def test_auto_compaction_success_emits_event(self):
        ...
        with (
            patch("scream.soul.screamsoul.wire_send"),
            patch("scream.telemetry.track") as mock_track,
        ):
